...
- The second brain has root-ghostproxy as a queryable entity (sister-projects.yaml entry, identity-profile.md, SFIF rollout epic, 10 module pages, 6 source-syntheses for Suricata + PolarProxy, two template lists).
...
- [ ] Operator decides M009's reframed scope:
  - **Option A:** M009 is now "verify second brain has root-ghostproxy as a queryable entity" (already proven; mark complete).
