...
Per the local-copy-and-adapt decision (T007) and Adoption Guide step 1, copy four configuration files from the second brain into root-ghostproxy's wiki/config/. The chosen profiles align with root-ghostproxy's Goldilocks identity:
