---
title: "T054 — Verify second brain's `wiki_sister_project root-ghostproxy` MCP tool returns valid output"
type: task
status: not-started
priority: P1
...
- [ ] MCP tool invocation: `wiki_sister_project root-ghostproxy` returns the sister entry: type=root, group=operating-system-setup, path=~/, auto_connect=false, etc.
- [ ] Output captured.
