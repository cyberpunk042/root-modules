...
| `"run regression tests"` / `"verified-edit"` (Hard Rule 14) | Unified runner across 20 test files — 12 hook + 8 tool (empirically verified 2026-07-03 on `main`) | `python3 -m tools.run-tests` (383/383 aggregate; prior "14 files / 322/322" figure was never in committed history — corrected per Hard Rule 15) |
