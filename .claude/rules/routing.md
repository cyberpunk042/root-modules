...
| `"run regression tests"` / `"verified-edit"` (Hard Rule 14) | Unified runner across 17 test files — 12 hook + 5 tool (empirically verified 2026-07-03 on `main`) | `python3 -m tools.run-tests` (323/323 aggregate; prior "14 files / 322/322" figure was never in committed history — corrected per Hard Rule 15) |
