...
| `"run regression tests"` / `"verified-edit"` (Hard Rule 14) | Unified runner across 24 test files — 16 hook + 8 tool (empirically verified 2026-07-03 on `main`) | `python3 -m tools.run-tests` (425/425 aggregate; prior "14 files / 322/322" figure was never in committed history — corrected per Hard Rule 15) |
